...
def generate_launch_description():
    ...
    map_file_arg = DeclareLaunchArgument(
        "map_file",
        default_value=os.path.join(get_package_share_directory("my_robot_cartographer"), "maps", "map.yaml"),
    ...
    amcl_params_file_arg = DeclareLaunchArgument(
        ...
        default_value=os.path.join(
            get_package_share_directory("my_robot_cartographer"), "config", "amcl.yaml"
        ),
